...
# NOTE: TestExtractMediapipeEndToEnd was removed when the MediaPipe
# pose backend was retired. The corresponding rtmpose end-to-end test
# lives earlier in this file as TestExtractRtmposeEndToEnd, which is
# the only path that ships now.
