...
const KEYFRAME_ANGLES: KeyframeAngles[] = [
  ...
  // clip). RTMPose-extracted, multi-stage smoothed, capped, biased.
  // See railway-service/convert_pose_to_keyframes.py.
  // Pipeline highlights:
  //   - 7-frame moving avg on positions, 5-frame on unwrapped angles
  //   - racket-head trajectory smoothed at the POSITION level
  //     (5-frame moving avg in screen-space) so the racket traces
  //     a clean curve rather than inheriting forearm-angle wobble.
  //     Per-frame racket angle + len recomputed from the smoothed
  //     head position relative to the wrist.
  //   - mirrored y-axis (right figure hits left toward opponent)
  //   - fArmR upward excursion 50% toward nearest horizontal
  //   - uArmR horizontal-LEFT reach (>145 unwrapped) scaled 30%
  //     (racket tip stays at shoulder height in follow-through)
  //   - off-arm (uArmL/fArmL) biased 40% toward a low rest pose
  //     (uArmL=95, fArmL=100): same motion shape but resting
  //     low at the side instead of mid-air.
  //   - post-contact t-values stretched (0.65 -> 0.92) so the
  //     follow-through plays back ~35% slower than the prep
  { t: 0.0, hipCenter: [0.5476, 0.5782], trunk: -95.5, neck: -107.6,
    uArmL: 92.3, fArmL: 105.7, uArmR: 78.3, fArmR: 115.3,
    thighL: 101.8, shinL: 71.7, thighR: 95.6, shinR: 76.7,
    racket: 116.5, racketLen: 0.099 },
  { t: 0.0217, hipCenter: [0.5466, 0.5771], trunk: -95.4, neck: -107.6,
    uArmL: 92.4, fArmL: 105.6, uArmR: 78.1, fArmR: 115.6,
    thighL: 101.4, shinL: 71.5, thighR: 95.1, shinR: 77.0,
    racket: 116.5, racketLen: 0.099 },
  { t: 0.0433, hipCenter: [0.5452, 0.5758], trunk: -95.2, neck: -107.7,
    uArmL: 92.6, fArmL: 105.1, uArmR: 77.8, fArmR: 116.1,
    thighL: 100.8, shinL: 71.3, thighR: 94.5, shinR: 77.5,
    racket: 116.4, racketLen: 0.099 },
  { t: 0.065, hipCenter: [0.5438, 0.574], trunk: -94.9, neck: -107.9,
    uArmL: 92.9, fArmL: 103.6, uArmR: 77.1, fArmR: 116.9,
    thighL: 99.6, shinL: 70.8, thighR: 93.4, shinR: 78.5,
    racket: 116.9, racketLen: 0.099 },
  { t: 0.0867, hipCenter: [0.5415, 0.5714], trunk: -94.5, neck: -108.0,
    uArmL: 93.2, fArmL: 100.1, uArmR: 76.2, fArmR: 117.6,
    thighL: 98.1, shinL: 70.3, thighR: 92.2, shinR: 79.7,
    racket: 117.4, racketLen: 0.099 },
  { t: 0.1083, hipCenter: [0.5388, 0.5684], trunk: -94.0, neck: -108.1,
    uArmL: 93.3, fArmL: 91.2, uArmR: 75.2, fArmR: 118.2,
    thighL: 96.4, shinL: 70.0, thighR: 91.1, shinR: 81.2,
    racket: 117.6, racketLen: 0.099 },
  { t: 0.13, hipCenter: [0.536, 0.5649], trunk: -93.5, neck: -108.1,
    uArmL: 93.1, fArmL: 76.6, uArmR: 73.8, fArmR: 118.8,
    thighL: 94.6, shinL: 69.8, thighR: 90.2, shinR: 82.7,
    racket: 118.0, racketLen: 0.099 },
  { t: 0.1517, hipCenter: [0.5331, 0.561], trunk: -92.9, neck: -108.0,
    uArmL: 92.7, fArmL: 60.8, uArmR: 72.2, fArmR: 118.7,
    thighL: 92.9, shinL: 69.7, thighR: 89.6, shinR: 84.2,
    racket: 120.5, racketLen: 0.099 },
  { t: 0.1733, hipCenter: [0.5302, 0.5575], trunk: -92.3, neck: -107.4,
    uArmL: 91.8, fArmL: 45.1, uArmR: 70.1, fArmR: 119.5,
    thighL: 91.6, shinL: 69.7, thighR: 89.4, shinR: 85.6,
    racket: 126.5, racketLen: 0.099 },
  { t: 0.195, hipCenter: [0.5275, 0.5545], trunk: -91.8, neck: -106.1,
    uArmL: 90.5, fArmL: 30.9, uArmR: 67.6, fArmR: 122.9,
    thighL: 90.7, shinL: 69.8, thighR: 89.5, shinR: 86.7,
    racket: 141.5, racketLen: 0.094 },
  { t: 0.2167, hipCenter: [0.5248, 0.5527], trunk: -91.2, neck: -104.6,
    uArmL: 88.7, fArmL: 21.7, uArmR: 64.2, fArmR: 133.9,
    thighL: 90.3, shinL: 69.8, thighR: 90.0, shinR: 87.5,
    racket: 160.2, racketLen: 0.082 },
  { t: 0.2383, hipCenter: [0.5222, 0.5527], trunk: -90.8, neck: -103.3,
    uArmL: 86.3, fArmL: 18.2, uArmR: 60.2, fArmR: 160.4,
    thighL: 90.4, shinL: 70.0, thighR: 90.6, shinR: 87.9,
    racket: 164.2, racketLen: 0.08 },
  { t: 0.26, hipCenter: [0.5194, 0.5536], trunk: -90.4, neck: -102.0,
    uArmL: 83.3, fArmL: 16.5, uArmR: 55.7, fArmR: -173.1,
    thighL: 91.0, shinL: 70.6, thighR: 91.2, shinR: 88.0,
    racket: 173.4, racketLen: 0.08 },
  { t: 0.2817, hipCenter: [0.5167, 0.5555], trunk: -90.1, neck: -101.0,
    uArmL: 79.9, fArmL: 15.9, uArmR: 51.0, fArmR: -154.9,
    thighL: 91.9, shinL: 71.8, thighR: 91.7, shinR: 87.6,
    racket: -127.1, racketLen: 0.08 },
  { t: 0.3033, hipCenter: [0.514, 0.5576], trunk: -89.9, neck: -100.9,
    uArmL: 76.3, fArmL: 16.7, uArmR: 46.4, fArmR: -136.7,
    thighL: 93.1, shinL: 73.8, thighR: 92.0, shinR: 87.0,
    racket: -4.7, racketLen: 0.08 },
  { t: 0.325, hipCenter: [0.5113, 0.5597], trunk: -89.7, neck: -101.3,
    uArmL: 73.2, fArmL: 18.4, uArmR: 42.5, fArmR: -30.1,
    thighL: 94.5, shinL: 76.6, thighR: 92.1, shinR: 86.0,
    racket: -153.2, racketLen: 0.08 },
  { t: 0.3467, hipCenter: [0.5084, 0.5611], trunk: -89.5, neck: -102.2,
    uArmL: 70.8, fArmL: 21.1, uArmR: 39.5, fArmR: -19.6,
    thighL: 95.9, shinL: 79.4, thighR: 92.0, shinR: 84.9,
    racket: -68.2, racketLen: 0.08 },
  { t: 0.3683, hipCenter: [0.5053, 0.5619], trunk: -89.4, neck: -103.0,
    uArmL: 69.8, fArmL: 24.5, uArmR: 38.1, fArmR: -11.2,
    thighL: 97.3, shinL: 81.9, thighR: 91.5, shinR: 83.8,
    racket: -11.1, racketLen: 0.092 },
  { t: 0.39, hipCenter: [0.5019, 0.5611], trunk: -89.2, neck: -103.9,
    uArmL: 70.5, fArmL: 28.1, uArmR: 38.2, fArmR: -3.5,
    thighL: 98.4, shinL: 83.8, thighR: 90.9, shinR: 82.6,
    racket: 1.9, racketLen: 0.092 },
  { t: 0.4117, hipCenter: [0.4984, 0.5594], trunk: -88.9, neck: -104.4,
    uArmL: 73.1, fArmL: 31.3, uArmR: 39.5, fArmR: 7.4,
    thighL: 99.3, shinL: 84.8, thighR: 90.1, shinR: 81.3,
    racket: 9.5, racketLen: 0.092 },
  { t: 0.4333, hipCenter: [0.4949, 0.5577], trunk: -88.6, neck: -104.2,
    uArmL: 77.4, fArmL: 33.8, uArmR: 42.1, fArmR: 18.5,
    thighL: 99.7, shinL: 84.9, thighR: 89.3, shinR: 80.2,
    racket: 15.9, racketLen: 0.092 },
  { t: 0.455, hipCenter: [0.4913, 0.5563], trunk: -88.2, neck: -102.5,
    uArmL: 83.1, fArmL: 34.8, uArmR: 45.4, fArmR: 27.5,
    thighL: 99.7, shinL: 84.6, thighR: 88.6, shinR: 79.1,
    racket: 24.5, racketLen: 0.094 },
  { t: 0.4767, hipCenter: [0.4878, 0.5548], trunk: -87.9, neck: -100.2,
    uArmL: 89.3, fArmL: 33.5, uArmR: 48.9, fArmR: 35.2,
    thighL: 99.3, shinL: 84.2, thighR: 88.0, shinR: 78.0,
    racket: 33.1, racketLen: 0.095 },
  { t: 0.4983, hipCenter: [0.4846, 0.5531], trunk: -87.7, neck: -97.6,
    uArmL: 95.4, fArmL: 27.5, uArmR: 52.7, fArmR: 41.8,
    thighL: 98.5, shinL: 83.8, thighR: 87.6, shinR: 76.9,
    racket: 40.7, racketLen: 0.095 },
  { t: 0.52, hipCenter: [0.4821, 0.5501], trunk: -87.7, neck: -94.8,
    uArmL: 100.8, fArmL: 16.1, uArmR: 57.5, fArmR: 47.9,
    thighL: 97.6, shinL: 83.8, thighR: 87.3, shinR: 76.9,
    racket: 46.9, racketLen: 0.095 },
  { t: 0.5417, hipCenter: [0.4802, 0.5462], trunk: -87.8, neck: -92.1,
    uArmL: 105.5, fArmL: 2.9, uArmR: 63.7, fArmR: 52.6,
    thighL: 96.7, shinL: 84.2, thighR: 87.1, shinR: 76.8,
    racket: 54.2, racketLen: 0.095 },
  { t: 0.5633, hipCenter: [0.4787, 0.5416], trunk: -88.2, neck: -90.3,
    uArmL: 109.6, fArmL: -155.0, uArmR: 71.3, fArmR: 57.0,
    thighL: 96.0, shinL: 84.9, thighR: 87.0, shinR: 76.7,
    racket: 67.8, racketLen: 0.092 },
  { t: 0.585, hipCenter: [0.4782, 0.5365], trunk: -88.6, neck: -89.4,
    uArmL: 113.4, fArmL: -167.9, uArmR: 80.8, fArmR: 63.5,
    thighL: 95.7, shinL: 85.8, thighR: 86.9, shinR: 76.4,
    racket: 91.8, racketLen: 0.084 },
  { t: 0.6067, hipCenter: [0.4781, 0.5316], trunk: -89.1, neck: -89.6,
    uArmL: 117.0, fArmL: -177.1, uArmR: 92.9, fArmR: 82.2,
    thighL: 95.7, shinL: 86.7, thighR: 86.8, shinR: 76.1,
    racket: 116.3, racketLen: 0.08 },
  { t: 0.6283, hipCenter: [0.4782, 0.5268], trunk: -89.5, neck: -90.6,
    uArmL: 120.4, fArmL: 179.3, uArmR: 107.7, fArmR: 112.6,
    thighL: 95.9, shinL: 87.4, thighR: 86.6, shinR: 74.4,
    racket: 139.6, racketLen: 0.08 },
  { t: 0.65, hipCenter: [0.4783, 0.5233], trunk: -89.9, neck: -92.4,
    uArmL: 123.8, fArmL: 177.8, uArmR: 124.9, fArmR: 146.8,
    thighL: 96.3, shinL: 87.8, thighR: 86.4, shinR: 72.3,
    racket: 134.9, racketLen: 0.08 },
  { t: 0.6669, hipCenter: [0.4782, 0.5221], trunk: -90.1, neck: -95.0,
    uArmL: 127.2, fArmL: 177.9, uArmR: 143.7, fArmR: -178.9,
    thighL: 96.6, shinL: 87.8, thighR: 86.1, shinR: 68.5,
    racket: 131.0, racketLen: 0.08 },
  { t: 0.6838, hipCenter: [0.4777, 0.5227], trunk: -90.3, neck: -98.1,
    uArmL: 130.0, fArmL: 178.2, uArmR: 150.2, fArmR: -163.1,
    thighL: 97.4, shinL: 87.5, thighR: 85.8, shinR: 64.4,
    racket: 169.5, racketLen: 0.08 },
  { t: 0.7006, hipCenter: [0.4771, 0.5259], trunk: -90.4, neck: -101.2,
    uArmL: 131.0, fArmL: 179.4, uArmR: 155.0, fArmR: -154.0,
    thighL: 98.4, shinL: 86.7, thighR: 85.6, shinR: 60.0,
    racket: -167.5, racketLen: 0.094 },
  { t: 0.7175, hipCenter: [0.477, 0.5295], trunk: -90.6, neck: -104.4,
    uArmL: 129.2, fArmL: 179.8, uArmR: 158.6, fArmR: -150.7,
    thighL: 99.8, shinL: 85.7, thighR: 85.6, shinR: 55.5,
    racket: -156.7, racketLen: 0.095 },
  { t: 0.7344, hipCenter: [0.477, 0.5336], trunk: -90.8, neck: -107.5,
    uArmL: 124.7, fArmL: 179.3, uArmR: 160.3, fArmR: -148.2,
    thighL: 101.5, shinL: 84.6, thighR: 85.8, shinR: 51.3,
    racket: -150.9, racketLen: 0.095 },
  { t: 0.7512, hipCenter: [0.4769, 0.5383], trunk: -91.2, neck: -110.5,
    uArmL: 117.9, fArmL: 177.4, uArmR: 159.6, fArmR: -146.0,
    thighL: 103.4, shinL: 83.7, thighR: 86.6, shinR: 49.0,
    racket: -146.0, racketLen: 0.095 },
  { t: 0.7681, hipCenter: [0.4771, 0.5426], trunk: -91.7, neck: -113.4,
    uArmL: 110.1, fArmL: 174.4, uArmR: 156.5, fArmR: -142.8,
    thighL: 105.1, shinL: 83.2, thighR: 87.8, shinR: 47.5,
    racket: -141.8, racketLen: 0.096 },
  { t: 0.785, hipCenter: [0.4776, 0.5456], trunk: -92.4, neck: -115.6,
    uArmL: 102.1, fArmL: 169.2, uArmR: 151.7, fArmR: -138.8,
    thighL: 106.5, shinL: 83.1, thighR: 89.5, shinR: 47.2,
    racket: -93.6, racketLen: 0.08 },
  { t: 0.8019, hipCenter: [0.4787, 0.5474], trunk: -93.1, neck: -117.3,
    uArmL: 95.7, fArmL: 162.4, uArmR: 146.2, fArmR: -135.3,
    thighL: 107.2, shinL: 83.6, thighR: 91.7, shinR: 48.2,
    racket: -34.5, racketLen: 0.089 },
  { t: 0.8188, hipCenter: [0.48, 0.547], trunk: -93.9, neck: -118.6,
    uArmL: 90.9, fArmL: 153.6, uArmR: 131.2, fArmR: -41.1,
    thighL: 107.3, shinL: 84.6, thighR: 94.1, shinR: 50.6,
    racket: -128.9, racketLen: 0.084 },
  { t: 0.8356, hipCenter: [0.4805, 0.5462], trunk: -94.6, neck: -119.0,
    uArmL: 87.3, fArmL: 144.9, uArmR: 116.4, fArmR: -37.4,
    thighL: 106.7, shinL: 86.0, thighR: 96.5, shinR: 54.0,
    racket: -84.6, racketLen: 0.08 },
  { t: 0.8525, hipCenter: [0.481, 0.5447], trunk: -95.3, neck: -119.1,
    uArmL: 84.7, fArmL: 137.5, uArmR: 107.0, fArmR: -33.9,
    thighL: 105.7, shinL: 87.5, thighR: 98.7, shinR: 57.7,
    racket: -39.2, racketLen: 0.097 },
  { t: 0.8694, hipCenter: [0.4819, 0.5433], trunk: -95.7, neck: -118.9,
    uArmL: 83.1, fArmL: 131.7, uArmR: 101.6, fArmR: -30.9,
    thighL: 104.5, shinL: 88.9, thighR: 100.5, shinR: 61.6,
    racket: -33.6, racketLen: 0.096 },
  { t: 0.8862, hipCenter: [0.4823, 0.5421], trunk: -96.1, neck: -118.7,
    uArmL: 81.9, fArmL: 127.3, uArmR: 98.5, fArmR: -26.7,
    thighL: 103.5, shinL: 90.1, thighR: 101.8, shinR: 65.4,
    racket: -31.7, racketLen: 0.097 },
  { t: 0.9031, hipCenter: [0.4827, 0.5409], trunk: -96.2, neck: -118.6,
    uArmL: 81.5, fArmL: 126.1, uArmR: 97.0, fArmR: -25.5,
    thighL: 102.9, shinL: 90.8, thighR: 102.4, shinR: 67.2,
    racket: -29.1, racketLen: 0.097 },
  { t: 0.92, hipCenter: [0.4831, 0.5403], trunk: -96.3, neck: -118.6,
    uArmL: 81.2, fArmL: 125.7, uArmR: 96.1, fArmR: -24.1,
    thighL: 102.6, shinL: 91.2, thighR: 102.9, shinR: 68.6,
    racket: -27.7, racketLen: 0.098 },
]
...
const RACKET_CONTACT_NORM_X = 0.2812
const RACKET_CONTACT_NORM_Y = 0.5167
