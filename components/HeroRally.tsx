...
const KEYFRAME_ANGLES: KeyframeAngles[] = [
  ...
  //        (handles the 180-degree wrap discontinuity),
  //      - racket angle = SMOOTHED forearm direction with a fixed
  //        0.13 length. The per-frame racket_head detector was
  //        wobbling 50+ degrees between adjacent frames in fast
  //        post-contact motion; deriving from the forearm cleans
  //        up the follow-through arc completely.
  ...
  //      capturing recovery toward ready so the loop seam is
  //      smooth.
...
const RACKET_CONTACT_NORM_X = 0.2038
const RACKET_CONTACT_NORM_Y = 0.4814
