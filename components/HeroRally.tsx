...
const KEYFRAME_ANGLES: KeyframeAngles[] = [
  ...
  // clip). RTMPose-extracted, smoothed, capped, dampened.
  // See railway-service/convert_pose_to_keyframes.py for the full
  // pipeline. Highlights:
  //   - 5-frame moving avg on positions, 3-frame on unwrapped angles
  ...
  //     so the racket tip during follow-through stays at shoulder
  //     height instead of sweeping above the head
  //   - off-arm (uArmL/fArmL) dampened 50% toward circular mean
  //     so the non-racket hand reads as supportive, not active
  //   - post-contact t-values stretched (0.65 -> 0.92 instead of
  //     0.65 -> 0.85) so the follow-through plays back ~35% slower
  //     than the prep, matching the visual cadence of a real swing
  { t: 0.0, hipCenter: [0.5487, 0.5786], trunk: -95.6, neck: -106.9,
    uArmL: 92.6, fArmL: -168.6, uArmR: 79.1, fArmR: 114.1,
    thighL: 102.5, shinL: 72.9, thighR: 96.9, shinR: 75.9,
    racket: 114.1, racketLen: 0.1 },
  { t: 0.0217, hipCenter: [0.5477, 0.5782], trunk: -95.6, neck: -107.2,
    uArmL: 92.7, fArmL: -168.9, uArmR: 78.8, fArmR: 114.5,
    thighL: 102.3, shinL: 72.5, thighR: 96.5, shinR: 76.2,
    racket: 114.5, racketLen: 0.1 },
  { t: 0.0433, hipCenter: [0.5467, 0.5771], trunk: -95.5, neck: -107.6,
    uArmL: 92.9, fArmL: -169.8, uArmR: 78.1, fArmR: 115.6,
  ...
  { t: 0.065, hipCenter: [0.5444, 0.5754], trunk: -95.3, neck: -108.1,
    uArmL: 93.2, fArmL: -170.7, uArmR: 77.4, fArmR: 116.9,
  ...
  { t: 0.0867, hipCenter: [0.5417, 0.5722], trunk: -94.8, neck: -108.3,
    uArmL: 93.6, fArmL: -171.9, uArmR: 76.4, fArmR: 118.2,
  ...
  { t: 0.1083, hipCenter: [0.5388, 0.5683], trunk: -94.1, neck: -108.5,
    uArmL: 94.0, fArmL: -174.8, uArmR: 75.6, fArmR: 119.2,
  ...
  { t: 0.13, hipCenter: [0.536, 0.5646], trunk: -93.4, neck: -108.2,
    uArmL: 94.2, fArmL: -6.3, uArmR: 74.3, fArmR: 119.6,
  ...
  { t: 0.1517, hipCenter: [0.533, 0.5608], trunk: -92.7, neck: -107.9,
    uArmL: 94.0, fArmL: -25.3, uArmR: 72.8, fArmR: 119.3,
    thighL: 92.2, shinL: 69.7, thighR: 88.6, shinR: 84.7,
    racket: 119.3, racketLen: 0.1 },
  { t: 0.1733, hipCenter: [0.5303, 0.5571], trunk: -92.2, neck: -107.7,
    uArmL: 93.1, fArmL: -44.3, uArmR: 70.7, fArmR: 118.7,
  ...
  { t: 0.195, hipCenter: [0.5275, 0.554], trunk: -91.8, neck: -107.7,
    uArmL: 91.8, fArmL: -55.7, uArmR: 68.2, fArmR: 117.1,
  ...
  { t: 0.4983, hipCenter: [0.4841, 0.5539], trunk: -87.3, neck: -99.4,
    uArmL: 96.3, fArmL: -49.9, uArmR: 51.6, fArmR: 41.7,
    thighL: 99.0, shinL: 82.9, thighR: 87.2, shinR: 77.0,
    racket: 41.7, racketLen: 0.1 },
  { t: 0.52, hipCenter: [0.4814, 0.5523], trunk: -87.2, neck: -95.8,
    uArmL: 101.6, fArmL: -58.7, uArmR: 55.2, fArmR: 46.9,
    thighL: 97.6, shinL: 82.8, thighR: 87.2, shinR: 75.7,
    racket: 46.9, racketLen: 0.1 },
  { t: 0.5417, hipCenter: [0.4794, 0.5487], trunk: -87.4, neck: -91.5,
    uArmL: 105.6, fArmL: -75.6, uArmR: 59.7, fArmR: 52.2,
    thighL: 96.2, shinL: 83.4, thighR: 87.2, shinR: 74.5,
    racket: 52.2, racketLen: 0.1 },
  { t: 0.5633, hipCenter: [0.4782, 0.5431], trunk: -87.9, neck: -88.1,
    uArmL: 108.4, fArmL: -93.5, uArmR: 66.4, fArmR: 58.7,
    thighL: 95.1, shinL: 84.4, thighR: 87.2, shinR: 75.9,
    racket: 58.7, racketLen: 0.1 },
  { t: 0.585, hipCenter: [0.4774, 0.5363], trunk: -88.5, neck: -86.3,
    uArmL: 110.6, fArmL: -104.4, uArmR: 76.3, fArmR: 63.9,
    thighL: 94.6, shinL: 85.8, thighR: 87.0, shinR: 77.4,
    racket: 63.9, racketLen: 0.1 },
  { t: 0.6067, hipCenter: [0.4778, 0.5297], trunk: -89.2, neck: -86.7,
    uArmL: 112.6, fArmL: -107.8, uArmR: 89.1, fArmR: 71.3,
    thighL: 94.9, shinL: 87.1, thighR: 86.8, shinR: 78.9,
    racket: 71.3, racketLen: 0.1 },
  { t: 0.6283, hipCenter: [0.4782, 0.5246], trunk: -89.8, neck: -88.9,
    uArmL: 115.4, fArmL: -108.8, uArmR: 105.3, fArmR: 106.9,
    thighL: 95.7, shinL: 88.1, thighR: 86.6, shinR: 77.4,
    racket: 106.9, racketLen: 0.1 },
  { t: 0.65, hipCenter: [0.4786, 0.5213], trunk: -90.2, neck: -92.2,
    uArmL: 119.4, fArmL: -110.4, uArmR: 124.7, fArmR: 158.6,
    thighL: 96.6, shinL: 88.6, thighR: 86.4, shinR: 75.5,
    racket: 158.6, racketLen: 0.1 },
  { t: 0.6669, hipCenter: [0.4788, 0.5201], trunk: -90.4, neck: -95.5,
    uArmL: 123.3, fArmL: -110.4, uArmR: 145.6, fArmR: -164.3,
    thighL: 97.3, shinL: 88.7, thighR: 86.2, shinR: 70.2,
    racket: -164.3, racketLen: 0.1 },
  { t: 0.6838, hipCenter: [0.4786, 0.5214], trunk: -90.5, neck: -98.0,
    uArmL: 126.3, fArmL: -110.2, uArmR: 152.5, fArmR: -154.4,
    thighL: 97.5, shinL: 88.2, thighR: 85.9, shinR: 64.1,
    racket: -154.4, racketLen: 0.1 },
  { t: 0.7006, hipCenter: [0.4774, 0.5237], trunk: -90.4, neck: -100.9,
    uArmL: 128.5, fArmL: -108.8, uArmR: 158.2, fArmR: -152.2,
    thighL: 97.3, shinL: 87.3, thighR: 85.5, shinR: 57.5,
    racket: -152.2, racketLen: 0.1 },
  { t: 0.7175, hipCenter: [0.4761, 0.5283], trunk: -90.3, neck: -104.0,
    uArmL: 129.0, fArmL: -107.7, uArmR: 162.0, fArmR: -151.6,
    thighL: 98.0, shinL: 86.0, thighR: 85.1, shinR: 53.7,
    racket: -151.6, racketLen: 0.1 },
  { t: 0.7344, hipCenter: [0.4762, 0.5335], trunk: -90.4, neck: -107.6,
    uArmL: 126.0, fArmL: -105.7, uArmR: 163.6, fArmR: -149.8,
    thighL: 99.9, shinL: 84.5, thighR: 85.0, shinR: 50.0,
    racket: -149.8, racketLen: 0.1 },
  { t: 0.7512, hipCenter: [0.4764, 0.5391], trunk: -90.8, neck: -111.1,
    uArmL: 118.6, fArmL: -106.0, uArmR: 163.5, fArmR: -146.6,
    thighL: 103.1, shinL: 82.9, thighR: 85.4, shinR: 47.0,
    racket: -146.6, racketLen: 0.1 },
  { t: 0.7681, hipCenter: [0.4768, 0.5441], trunk: -91.3, neck: -114.5,
    uArmL: 109.7, fArmL: -108.6, uArmR: 160.7, fArmR: -142.9,
    thighL: 106.3, shinL: 81.9, thighR: 86.5, shinR: 45.2,
    racket: -142.9, racketLen: 0.1 },
  { t: 0.785, hipCenter: [0.4779, 0.548], trunk: -92.2, neck: -117.3,
    uArmL: 101.0, fArmL: -114.5, uArmR: 154.7, fArmR: -137.8,
    thighL: 108.8, shinL: 81.7, thighR: 88.5, shinR: 44.9,
    racket: -137.8, racketLen: 0.1 },
  { t: 0.8019, hipCenter: [0.4794, 0.5489], trunk: -93.2, neck: -118.7,
    uArmL: 94.5, fArmL: -121.9, uArmR: 146.8, fArmR: -43.3,
    thighL: 109.6, shinL: 82.4, thighR: 91.2, shinR: 46.0,
    racket: -43.3, racketLen: 0.1 },
  { t: 0.8188, hipCenter: [0.4797, 0.5487], trunk: -94.1, neck: -119.5,
    uArmL: 89.8, fArmL: -131.7, uArmR: 127.8, fArmR: -37.9,
    thighL: 108.8, shinL: 83.9, thighR: 94.2, shinR: 48.1,
    racket: -37.9, racketLen: 0.1 },
  { t: 0.8356, hipCenter: [0.4803, 0.547], trunk: -94.9, neck: -119.5,
    uArmL: 87.3, fArmL: -140.5, uArmR: 112.3, fArmR: -34.9,
    thighL: 107.1, shinL: 85.9, thighR: 97.2, shinR: 51.9,
    racket: -34.9, racketLen: 0.1 },
  { t: 0.8525, hipCenter: [0.4812, 0.5446], trunk: -95.6, neck: -119.5,
    uArmL: 85.5, fArmL: -147.3, uArmR: 103.6, fArmR: -32.3,
    thighL: 105.4, shinL: 88.0, thighR: 99.7, shinR: 56.9,
    racket: -32.3, racketLen: 0.1 },
  { t: 0.8694, hipCenter: [0.482, 0.5421], trunk: -96.1, neck: -119.0,
    uArmL: 84.5, fArmL: -150.2, uArmR: 98.6, fArmR: -30.5,
    thighL: 103.9, shinL: 89.7, thighR: 101.6, shinR: 62.7,
    racket: -30.5, racketLen: 0.1 },
  { t: 0.8862, hipCenter: [0.4828, 0.5409], trunk: -96.4, neck: -118.7,
    uArmL: 83.7, fArmL: -152.3, uArmR: 96.2, fArmR: -25.4,
    thighL: 102.9, shinL: 91.0, thighR: 102.8, shinR: 67.7,
    racket: -25.4, racketLen: 0.1 },
  { t: 0.9031, hipCenter: [0.4831, 0.5403], trunk: -96.4, neck: -118.1,
    uArmL: 83.2, fArmL: -154.6, uArmR: 95.2, fArmR: -12.9,
    thighL: 102.0, shinL: 91.7, thighR: 103.4, shinR: 72.1,
    racket: -12.9, racketLen: 0.1 },
  { t: 0.92, hipCenter: [0.4834, 0.5402], trunk: -96.5, neck: -117.9,
    uArmL: 82.9, fArmL: -155.7, uArmR: 94.8, fArmR: -6.2,
    thighL: 101.7, shinL: 91.9, thighR: 103.7, shinR: 73.9,
    racket: -6.2, racketLen: 0.1 },
]
...
const RACKET_CONTACT_NORM_X = 0.2317
const RACKET_CONTACT_NORM_Y = 0.4705
