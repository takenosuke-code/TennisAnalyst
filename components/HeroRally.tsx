...
const KEYFRAME_ANGLES: KeyframeAngles[] = [
  // 47 keyframes from a Carlos Alcaraz forehand. RTMPose-extracted,
  // smoothed via two stages (positions then unwrapped angles), with
  // a tighter upper-arm cap to keep the racket below head height.
  // See railway-service/convert_pose_to_keyframes.py for full pipeline.
  // Notable choices:
  //   - 7-frame moving avg on positions, 5-frame on most unwrapped
  //     angles, 9-frame on the racket-arm channels (uArmR / fArmR /
  //     racket) for an extra-clean trace.
  //   - racket angle = smoothed forearm direction (no separate
  //     position-level smoothing on racket head; that approach had
  //     atan2 noise at fast-rotation phases when adjacent racket
  //     heads landed on opposite sides of the wrist).
  //   - mirrored y-axis (right figure hits left toward opponent).
  //   - uArmR horizontal-LEFT reach capped at 120 deg unwrapped
  //     (excess scaled 25%): keeps elbow well below shoulder so the
  //     forearm pointing up at follow-through doesn't put the
  //     racket above the head.
  //   - off-arm biased 40%% toward a low rest pose (uArmL=95,
  //     fArmL=100): same motion shape but resting low at the side.
  ...
  { t: 0.0, hipCenter: [0.5476, 0.5782], trunk: -95.5, neck: -107.6,
    uArmL: 92.3, fArmL: 105.7, uArmR: 77.8, fArmR: 116.1,
  ...
  { t: 0.0217, hipCenter: [0.5466, 0.5771], trunk: -95.4, neck: -107.6,
    uArmL: 92.4, fArmL: 105.6, uArmR: 77.4, fArmR: 116.5,
  ...
  { t: 0.0433, hipCenter: [0.5452, 0.5758], trunk: -95.2, neck: -107.7,
    uArmL: 92.6, fArmL: 105.1, uArmR: 76.9, fArmR: 116.8,
  ...
  { t: 0.065, hipCenter: [0.5438, 0.574], trunk: -94.9, neck: -107.9,
    uArmL: 92.9, fArmL: 103.6, uArmR: 76.3, fArmR: 117.1,
  ...
  { t: 0.0867, hipCenter: [0.5415, 0.5714], trunk: -94.5, neck: -108.0,
    uArmL: 93.2, fArmL: 100.1, uArmR: 75.7, fArmR: 117.4,
  ...
  { t: 0.1083, hipCenter: [0.5388, 0.5684], trunk: -94.0, neck: -108.1,
    uArmL: 93.3, fArmL: 91.2, uArmR: 74.6, fArmR: 117.7,
  ...
  { t: 0.13, hipCenter: [0.536, 0.5649], trunk: -93.5, neck: -108.1,
    uArmL: 93.1, fArmL: 76.6, uArmR: 73.1, fArmR: 118.5,
  ...
  { t: 0.1517, hipCenter: [0.5331, 0.561], trunk: -92.9, neck: -108.0,
    uArmL: 92.7, fArmL: 60.8, uArmR: 71.3, fArmR: 120.7,
  ...
  { t: 0.1733, hipCenter: [0.5302, 0.5575], trunk: -92.3, neck: -107.4,
    uArmL: 91.8, fArmL: 45.1, uArmR: 68.8, fArmR: 127.1,
  ...
  { t: 0.195, hipCenter: [0.5275, 0.5545], trunk: -91.8, neck: -106.1,
    uArmL: 90.5, fArmL: 30.9, uArmR: 65.9, fArmR: 142.0,
  ...
  { t: 0.2167, hipCenter: [0.5248, 0.5527], trunk: -91.2, neck: -104.6,
    uArmL: 88.7, fArmL: 21.7, uArmR: 62.7, fArmR: 160.4,
  ...
  { t: 0.2383, hipCenter: [0.5222, 0.5527], trunk: -90.8, neck: -103.3,
    uArmL: 86.3, fArmL: 18.2, uArmR: 59.1, fArmR: -179.0,
  ...
  { t: 0.26, hipCenter: [0.5194, 0.5536], trunk: -90.4, neck: -102.0,
    uArmL: 83.3, fArmL: 16.5, uArmR: 55.3, fArmR: -156.9,
  ...
  { t: 0.2817, hipCenter: [0.5167, 0.5555], trunk: -90.1, neck: -101.0,
    uArmL: 79.9, fArmL: 15.9, uArmR: 51.4, fArmR: -132.3,
  ...
  { t: 0.3033, hipCenter: [0.514, 0.5576], trunk: -89.9, neck: -100.9,
    uArmL: 76.3, fArmL: 16.7, uArmR: 47.8, fArmR: -105.7,
  ...
  { t: 0.325, hipCenter: [0.5113, 0.5597], trunk: -89.7, neck: -101.3,
    uArmL: 73.2, fArmL: 18.4, uArmR: 44.9, fArmR: -78.3,
  ...
  { t: 0.3467, hipCenter: [0.5084, 0.5611], trunk: -89.5, neck: -102.2,
    uArmL: 70.8, fArmL: 21.1, uArmR: 42.7, fArmR: -51.1,
  ...
  { t: 0.3683, hipCenter: [0.5053, 0.5619], trunk: -89.4, neck: -103.0,
    uArmL: 69.8, fArmL: 24.5, uArmR: 41.6, fArmR: -27.2,
  ...
  { t: 0.39, hipCenter: [0.5019, 0.5611], trunk: -89.2, neck: -103.9,
    uArmL: 70.5, fArmL: 28.1, uArmR: 41.4, fArmR: -11.1,
  ...
  { t: 0.4117, hipCenter: [0.4984, 0.5594], trunk: -88.9, neck: -104.4,
    uArmL: 73.1, fArmL: 31.3, uArmR: 42.0, fArmR: 1.9,
  ...
  { t: 0.4333, hipCenter: [0.4949, 0.5577], trunk: -88.6, neck: -104.2,
    uArmL: 77.4, fArmL: 33.8, uArmR: 43.7, fArmR: 13.4,
  ...
  { t: 0.455, hipCenter: [0.4913, 0.5563], trunk: -88.2, neck: -102.5,
    uArmL: 83.1, fArmL: 34.8, uArmR: 46.3, fArmR: 24.0,
  ...
  { t: 0.4767, hipCenter: [0.4878, 0.5548], trunk: -87.9, neck: -100.2,
    uArmL: 89.3, fArmL: 33.5, uArmR: 49.9, fArmR: 32.9,
  ...
  { t: 0.4983, hipCenter: [0.4846, 0.5531], trunk: -87.7, neck: -97.6,
    uArmL: 95.4, fArmL: 27.5, uArmR: 54.8, fArmR: 39.8,
  ...
  { t: 0.52, hipCenter: [0.4821, 0.5501], trunk: -87.7, neck: -94.8,
    uArmL: 100.8, fArmL: 16.1, uArmR: 60.5, fArmR: 46.0,
  ...
  { t: 0.5417, hipCenter: [0.4802, 0.5462], trunk: -87.8, neck: -92.1,
    uArmL: 105.5, fArmL: 2.9, uArmR: 67.4, fArmR: 52.5,
  ...
  { t: 0.5633, hipCenter: [0.4787, 0.5416], trunk: -88.2, neck: -90.3,
    uArmL: 109.6, fArmL: -155.0, uArmR: 75.9, fArmR: 65.5,
  ...
  { t: 0.585, hipCenter: [0.4782, 0.5365], trunk: -88.6, neck: -89.4,
    uArmL: 113.4, fArmL: -167.9, uArmR: 86.4, fArmR: 85.2,
  ...
  { t: 0.6067, hipCenter: [0.4781, 0.5316], trunk: -89.1, neck: -89.6,
    uArmL: 117.0, fArmL: -177.1, uArmR: 99.0, fArmR: 106.2,
  ...
  { t: 0.6283, hipCenter: [0.4782, 0.5268], trunk: -89.5, neck: -90.6,
    uArmL: 120.4, fArmL: 179.3, uArmR: 113.2, fArmR: 127.7,
  ...
  { t: 0.65, hipCenter: [0.4783, 0.5233], trunk: -89.9, neck: -92.4,
    uArmL: 123.8, fArmL: 177.8, uArmR: 122.1, fArmR: 148.2,
  ...
  { t: 0.6669, hipCenter: [0.4782, 0.5221], trunk: -90.1, neck: -95.0,
    uArmL: 127.2, fArmL: 177.9, uArmR: 125.8, fArmR: 167.8,
  ...
  { t: 0.6838, hipCenter: [0.4777, 0.5227], trunk: -90.3, neck: -98.1,
    uArmL: 130.0, fArmL: 178.2, uArmR: 129.2, fArmR: -171.5,
  ...
  { t: 0.7006, hipCenter: [0.4771, 0.5259], trunk: -90.4, neck: -101.2,
    uArmL: 131.0, fArmL: 179.4, uArmR: 132.0, fArmR: -150.2,
  ...
  { t: 0.7175, hipCenter: [0.477, 0.5295], trunk: -90.6, neck: -104.4,
    uArmL: 129.2, fArmL: 179.8, uArmR: 134.0, fArmR: -129.8,
  ...
  { t: 0.7344, hipCenter: [0.477, 0.5336], trunk: -90.8, neck: -107.5,
    uArmL: 124.7, fArmL: 179.3, uArmR: 134.6, fArmR: -116.2,
  ...
  { t: 0.7512, hipCenter: [0.4769, 0.5383], trunk: -91.2, neck: -110.5,
    uArmL: 117.9, fArmL: 177.4, uArmR: 134.1, fArmR: -109.0,
  ...
  { t: 0.7681, hipCenter: [0.4771, 0.5426], trunk: -91.7, neck: -113.4,
    uArmL: 110.1, fArmL: 174.4, uArmR: 132.5, fArmR: -103.4,
  ...
  { t: 0.785, hipCenter: [0.4776, 0.5456], trunk: -92.4, neck: -115.6,
    uArmL: 102.1, fArmL: 169.2, uArmR: 130.3, fArmR: -97.1,
  ...
  { t: 0.8019, hipCenter: [0.4787, 0.5474], trunk: -93.1, neck: -117.3,
    uArmL: 95.7, fArmL: 162.4, uArmR: 127.6, fArmR: -90.2,
...
const RACKET_CONTACT_NORM_X = 0.2569
const RACKET_CONTACT_NORM_Y = 0.514
