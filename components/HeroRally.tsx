...
const KEYFRAME_ANGLES: KeyframeAngles[] = [
  // 56 keyframes from a Carlos Alcaraz forehand (1.0s pre-contact +
  // 0.85s post). RTMPose-extracted, multi-stage smoothed.
  // See railway-service/convert_pose_to_keyframes.py for the
  // full pipeline. Notable choices:
  ...
  //     Tried position-level racket smoothing — it had atan2 noise
  //     at fast-rotation phases when adjacent racket heads landed
  //     on opposite sides of the wrist (100+ deg angle jumps).
  //   - mirrored y-axis (right figure hits left toward opponent).
  //   - uArmR cap: horizontal-LEFT reach >120 deg unwrapped scaled
  //     25%, keeps elbow well below shoulder so forearm pointing up
  //     at follow-through doesn't put racket above head.
  //   - off-arm dampened toward (uArmL=95, fArmL=100) IN UNWRAPPED
  //     SPACE with gain=0.65: prevents the off-arm from doing a
  //     full circle (its raw Alcaraz trajectory spans ~340 deg
  //     unwrapped, which would wrap through ±180; dampened span is
  //     ~115 deg, so it raises and returns without wrapping).
  //   - extended post-contact window (0.85s vs prior 0.55s):
  //     captures more of Alcaraz's recovery toward ready, so the
  //     racket-arm loop seam goes from a 173 deg whip to a 5 deg
  //     transition.
  ...
  { t: 0.0, hipCenter: [0.5488, 0.5805], trunk: -95.5, neck: -107.6,
    uArmL: 93.4, fArmL: 103.3, uArmR: 77.8, fArmR: 116.1,
  ...
  { t: 0.0217, hipCenter: [0.5478, 0.5794], trunk: -95.4, neck: -107.6,
    uArmL: 93.5, fArmL: 103.3, uArmR: 77.4, fArmR: 116.5,
  ...
  { t: 0.0433, hipCenter: [0.5464, 0.5781], trunk: -95.2, neck: -107.7,
    uArmL: 93.6, fArmL: 103.0, uArmR: 76.9, fArmR: 116.8,
  ...
  { t: 0.065, hipCenter: [0.545, 0.5763], trunk: -94.9, neck: -107.9,
    uArmL: 93.8, fArmL: 102.1, uArmR: 76.3, fArmR: 117.1,
  ...
  { t: 0.0867, hipCenter: [0.5426, 0.5737], trunk: -94.5, neck: -108.0,
    uArmL: 94.0, fArmL: 100.0, uArmR: 75.7, fArmR: 117.4,
  ...
  { t: 0.1083, hipCenter: [0.54, 0.5707], trunk: -94.0, neck: -108.1,
    uArmL: 94.0, fArmL: 94.9, uArmR: 74.6, fArmR: 117.7,
  ...
  { t: 0.13, hipCenter: [0.5372, 0.5671], trunk: -93.5, neck: -108.1,
    uArmL: 93.9, fArmL: 86.3, uArmR: 73.1, fArmR: 118.5,
  ...
  { t: 0.1517, hipCenter: [0.5343, 0.5632], trunk: -92.9, neck: -108.0,
    uArmL: 93.6, fArmL: 77.1, uArmR: 71.3, fArmR: 120.7,
  ...
  { t: 0.1733, hipCenter: [0.5313, 0.5597], trunk: -92.3, neck: -107.4,
    uArmL: 93.1, fArmL: 68.0, uArmR: 68.8, fArmR: 127.1,
  ...
  { t: 0.195, hipCenter: [0.5286, 0.5567], trunk: -91.8, neck: -106.1,
    uArmL: 92.4, fArmL: 59.7, uArmR: 65.9, fArmR: 142.0,
  ...
  { t: 0.2167, hipCenter: [0.526, 0.5549], trunk: -91.2, neck: -104.6,
    uArmL: 91.3, fArmL: 54.3, uArmR: 62.7, fArmR: 160.4,
  ...
  { t: 0.2383, hipCenter: [0.5233, 0.5549], trunk: -90.8, neck: -103.3,
    uArmL: 89.9, fArmL: 52.3, uArmR: 59.1, fArmR: -179.0,
  ...
  { t: 0.26, hipCenter: [0.5206, 0.5559], trunk: -90.4, neck: -102.0,
    uArmL: 88.2, fArmL: 51.3, uArmR: 55.3, fArmR: -156.9,
  ...
  { t: 0.2817, hipCenter: [0.5178, 0.5577], trunk: -90.1, neck: -101.0,
    uArmL: 86.2, fArmL: 51.0, uArmR: 51.4, fArmR: -132.3,
  ...
  { t: 0.3033, hipCenter: [0.5151, 0.5598], trunk: -89.9, neck: -100.9,
    uArmL: 84.1, fArmL: 51.4, uArmR: 47.8, fArmR: -105.7,
  ...
  { t: 0.325, hipCenter: [0.5124, 0.562], trunk: -89.7, neck: -101.3,
    uArmL: 82.3, fArmL: 52.4, uArmR: 44.9, fArmR: -78.3,
  ...
  { t: 0.3467, hipCenter: [0.5095, 0.5633], trunk: -89.5, neck: -102.2,
    uArmL: 80.9, fArmL: 54.0, uArmR: 42.7, fArmR: -51.1,
  ...
  { t: 0.3683, hipCenter: [0.5063, 0.5642], trunk: -89.4, neck: -103.0,
    uArmL: 80.3, fArmL: 56.0, uArmR: 41.6, fArmR: -27.2,
  ...
  { t: 0.39, hipCenter: [0.5029, 0.5634], trunk: -89.2, neck: -103.9,
    uArmL: 80.7, fArmL: 58.1, uArmR: 41.4, fArmR: -11.1,
  ...
  { t: 0.4117, hipCenter: [0.4995, 0.5616], trunk: -88.9, neck: -104.4,
    uArmL: 82.2, fArmL: 59.9, uArmR: 42.0, fArmR: 1.9,
  ...
  { t: 0.4333, hipCenter: [0.4959, 0.56], trunk: -88.6, neck: -104.2,
    uArmL: 84.8, fArmL: 61.4, uArmR: 43.7, fArmR: 13.4,
  ...
  { t: 0.455, hipCenter: [0.4923, 0.5585], trunk: -88.2, neck: -102.5,
    uArmL: 88.1, fArmL: 62.0, uArmR: 46.3, fArmR: 24.0,
  ...
  { t: 0.4767, hipCenter: [0.4888, 0.557], trunk: -87.9, neck: -100.2,
    uArmL: 91.7, fArmL: 61.2, uArmR: 49.9, fArmR: 32.9,
  ...
  { t: 0.4983, hipCenter: [0.4856, 0.5554], trunk: -87.7, neck: -97.6,
    uArmL: 95.2, fArmL: 57.7, uArmR: 54.8, fArmR: 39.8,
  ...
  { t: 0.52, hipCenter: [0.4831, 0.5523], trunk: -87.7, neck: -94.8,
    uArmL: 98.4, fArmL: 51.1, uArmR: 60.5, fArmR: 46.0,
  ...
  { t: 0.5417, hipCenter: [0.4812, 0.5484], trunk: -87.8, neck: -92.1,
    uArmL: 101.1, fArmL: 43.4, uArmR: 67.4, fArmR: 52.5,
  ...
  { t: 0.5633, hipCenter: [0.4797, 0.5438], trunk: -88.2, neck: -90.3,
    uArmL: 103.5, fArmL: 35.3, uArmR: 75.9, fArmR: 65.5,
  ...
  { t: 0.585, hipCenter: [0.4792, 0.5387], trunk: -88.6, neck: -89.4,
    uArmL: 105.7, fArmL: 27.7, uArmR: 86.4, fArmR: 85.2,
  ...
  { t: 0.6067, hipCenter: [0.4791, 0.5338], trunk: -89.1, neck: -89.6,
    uArmL: 107.8, fArmL: 22.3, uArmR: 99.0, fArmR: 106.2,
  ...
  { t: 0.6283, hipCenter: [0.4791, 0.5289], trunk: -89.5, neck: -90.6,
    uArmL: 109.8, fArmL: 20.3, uArmR: 113.2, fArmR: 127.7,
  ...
  { t: 0.65, hipCenter: [0.4793, 0.5254], trunk: -89.9, neck: -92.4,
    uArmL: 111.8, fArmL: 19.4, uArmR: 122.1, fArmR: 148.2,
  ...
  { t: 0.6608, hipCenter: [0.4791, 0.5242], trunk: -90.1, neck: -95.0,
    uArmL: 113.8, fArmL: 19.4, uArmR: 125.8, fArmR: 167.8,
  ...
  { t: 0.6716, hipCenter: [0.4787, 0.5248], trunk: -90.3, neck: -98.1,
    uArmL: 115.4, fArmL: 19.6, uArmR: 129.2, fArmR: -171.5,
  ...
  { t: 0.6824, hipCenter: [0.4781, 0.5281], trunk: -90.4, neck: -101.2,
    uArmL: 116.0, fArmL: 20.3, uArmR: 132.0, fArmR: -150.2,
  ...
  { t: 0.6932, hipCenter: [0.478, 0.5317], trunk: -90.6, neck: -104.4,
    uArmL: 114.9, fArmL: 20.6, uArmR: 134.0, fArmR: -129.8,
  ...
  { t: 0.704, hipCenter: [0.478, 0.5358], trunk: -90.8, neck: -107.5,
    uArmL: 112.3, fArmL: 20.3, uArmR: 134.6, fArmR: -116.2,
  ...
  { t: 0.7148, hipCenter: [0.4778, 0.5405], trunk: -91.2, neck: -110.5,
    uArmL: 108.4, fArmL: 19.1, uArmR: 134.1, fArmR: -109.0,
  ...
  { t: 0.7256, hipCenter: [0.4781, 0.5447], trunk: -91.7, neck: -113.4,
    uArmL: 103.8, fArmL: 17.4, uArmR: 132.5, fArmR: -103.4,
  ...
  { t: 0.7364, hipCenter: [0.4786, 0.5478], trunk: -92.4, neck: -115.6,
    uArmL: 99.1, fArmL: 14.3, uArmR: 130.3, fArmR: -97.1,
  ...
  { t: 0.7472, hipCenter: [0.4796, 0.5496], trunk: -93.1, neck: -117.3,
    uArmL: 95.4, fArmL: 10.4, uArmR: 127.6, fArmR: -90.2,
  ...
  { t: 0.758, hipCenter: [0.481, 0.5492], trunk: -93.9, neck: -118.6,
    uArmL: 92.6, fArmL: 5.3, uArmR: 124.7, fArmR: -81.1,
  ...
  { t: 0.7688, hipCenter: [0.4814, 0.5484], trunk: -94.6, neck: -119.0,
    uArmL: 90.5, fArmL: 0.2, uArmR: 121.8, fArmR: -62.0,
  ...
  { t: 0.7796, hipCenter: [0.482, 0.5469], trunk: -95.2, neck: -119.1,
    uArmL: 89.0, fArmL: -4.2, uArmR: 116.2, fArmR: -39.9,
  ...
  { t: 0.7904, hipCenter: [0.4829, 0.5455], trunk: -95.6, neck: -119.0,
    uArmL: 88.0, fArmL: -7.5, uArmR: 107.6, fArmR: -17.9,
  ...
  { t: 0.8012, hipCenter: [0.4835, 0.5446], trunk: -95.7, neck: -118.7,
    uArmL: 87.3, fArmL: -9.8, uArmR: 102.3, fArmR: 3.6,
  ...
  { t: 0.812, hipCenter: [0.4843, 0.5442], trunk: -95.6, neck: -118.5,
    uArmL: 87.1, fArmL: -10.5, uArmR: 99.5, fArmR: 24.5,
  ...
  { t: 0.8228, hipCenter: [0.4851, 0.5444], trunk: -95.4, neck: -118.3,
    uArmL: 87.0, fArmL: -10.6, uArmR: 97.9, fArmR: 45.2,
  ...
  { t: 0.8336, hipCenter: [0.4861, 0.5448], trunk: -95.2, neck: -117.9,
    uArmL: 87.0, fArmL: -10.5, uArmR: 96.9, fArmR: 64.3,
  ...
  { t: 0.8444, hipCenter: [0.4876, 0.5444], trunk: -94.9, neck: -117.6,
    uArmL: 87.3, fArmL: -10.4, uArmR: 96.2, fArmR: 83.3,
  ...
  { t: 0.8552, hipCenter: [0.4894, 0.5434], trunk: -94.8, neck: -117.3,
    uArmL: 87.7, fArmL: -10.4, uArmR: 95.7, fArmR: 100.3,
  ...
  { t: 0.866, hipCenter: [0.4915, 0.5414], trunk: -94.8, neck: -117.0,
    uArmL: 88.4, fArmL: -10.4, uArmR: 95.2, fArmR: 106.4,
  ...
  { t: 0.8768, hipCenter: [0.494, 0.5389], trunk: -94.9, neck: -116.6,
    uArmL: 89.1, fArmL: -10.6, uArmR: 94.5, fArmR: 108.4,
  ...
  { t: 0.8876, hipCenter: [0.4966, 0.5364], trunk: -95.1, neck: -116.2,
    uArmL: 89.8, fArmL: -11.1, uArmR: 94.3, fArmR: 109.3,
  ...
  { t: 0.8984, hipCenter: [0.4981, 0.5346], trunk: -95.3, neck: -115.8,
    uArmL: 90.6, fArmL: -11.7, uArmR: 93.9, fArmR: 110.1,
  ...
  { t: 0.9092, hipCenter: [0.4996, 0.5324], trunk: -95.4, neck: -115.6,
    uArmL: 91.0, fArmL: -12.0, uArmR: 93.3, fArmR: 110.8,
  ...
  { t: 0.92, hipCenter: [0.501, 0.5307], trunk: -95.5, neck: -115.4,
    uArmL: 91.2, fArmL: -12.3, uArmR: 92.7, fArmR: 111.5,
