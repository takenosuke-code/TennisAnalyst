...
const KEYFRAME_ANGLES: KeyframeAngles[] = [
  ...
  // clip). RTMPose-extracted, smoothed, capped, lightly dampened.
  // See railway-service/convert_pose_to_keyframes.py.
  // Pipeline:
  //   - 7-frame moving avg on positions, 5-frame on unwrapped
  //     angles (bumped from 5/3 because the racket arm was reading
  //     jittery; wider window = smoother arc, slight peak attenuation)
  //   - racket angle = forearm direction (no detector noise),
  //     racketLen = fixed 0.10
  ...
  //   - off-arm (uArmL/fArmL) lightly dampened 25%% toward circular
  //     mean — same motion shape, smaller amplitude
...
const RACKET_CONTACT_NORM_X = 0.254
const RACKET_CONTACT_NORM_Y = 0.5147
