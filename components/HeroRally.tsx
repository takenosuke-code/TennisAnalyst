...
const KEYFRAME_ANGLES: KeyframeAngles[] = [
  // 40 keyframes from a Carlos Alcaraz forehand (side-on broadcast
  ...
  //   3. Window: 1.1s pre-contact + 0.2s post-contact (40 frames).
  //      Contact lands at local idx 33 -> t=0.65 (matches
  //      SWING_CONTACT_PHASE so the ball-contact check fires at
  //      the right moment).
  ...
  { t: 0.0, hipCenter: [0.5419, 0.5674], trunk: -94.1, neck: -108.6,
    uArmL: 89.6, fArmL: 120.1, uArmR: 81.5, fArmR: 114.7,
    thighL: 100.9, shinL: 77.6, thighR: 96.1, shinR: 78.0,
    racket: -154.9, racketLen: 0.117 },
  { t: 0.0197, hipCenter: [0.5415, 0.5691], trunk: -94.2, neck: -108.3,
    uArmL: 89.6, fArmL: 119.4, uArmR: 81.4, fArmR: 114.5,
    thighL: 101.1, shinL: 77.2, thighR: 96.3, shinR: 77.8,
    racket: -154.2, racketLen: 0.12 },
  { t: 0.0394, hipCenter: [0.5412, 0.5705], trunk: -94.6, neck: -107.8,
    uArmL: 89.6, fArmL: 117.8, uArmR: 80.9, fArmR: 114.2,
    thighL: 101.4, shinL: 76.4, thighR: 96.6, shinR: 77.2,
    racket: -152.4, racketLen: 0.122 },
  { t: 0.0591, hipCenter: [0.5403, 0.5727], trunk: -95.0, neck: -107.4,
    uArmL: 89.7, fArmL: 115.4, uArmR: 80.2, fArmR: 114.1,
    thighL: 101.8, shinL: 75.2, thighR: 96.7, shinR: 76.7,
    racket: -150.4, racketLen: 0.127 },
  { t: 0.0788, hipCenter: [0.539, 0.5739], trunk: -95.3, neck: -107.4,
    uArmL: 90.1, fArmL: 112.4, uArmR: 79.3, fArmR: 114.4,
    thighL: 101.9, shinL: 73.6, thighR: 96.4, shinR: 76.5,
    racket: -148.2, racketLen: 0.131 },
  { t: 0.0985, hipCenter: [0.5374, 0.5738], trunk: -95.5, neck: -107.6,
    uArmL: 90.6, fArmL: 109.5, uArmR: 78.3, fArmR: 115.5,
    thighL: 101.7, shinL: 71.8, thighR: 95.5, shinR: 76.8,
    racket: -145.9, racketLen: 0.132 },
  { t: 0.1182, hipCenter: [0.5352, 0.5721], trunk: -95.3, neck: -108.1,
    uArmL: 91.3, fArmL: 106.9, uArmR: 77.4, fArmR: 116.9,
    thighL: 100.6, shinL: 70.5, thighR: 93.9, shinR: 77.8,
    racket: -143.4, racketLen: 0.135 },
  { t: 0.1379, hipCenter: [0.5325, 0.5689], trunk: -94.8, neck: -108.3,
    uArmL: 92.1, fArmL: 104.4, uArmR: 76.4, fArmR: 118.2,
    thighL: 98.9, shinL: 69.7, thighR: 92.1, shinR: 79.2,
    racket: -140.6, racketLen: 0.138 },
  { t: 0.1576, hipCenter: [0.5297, 0.5651], trunk: -94.1, neck: -108.5,
    uArmL: 92.9, fArmL: 98.8, uArmR: 75.6, fArmR: 119.2,
    thighL: 96.7, shinL: 69.6, thighR: 90.4, shinR: 80.9,
    racket: -137.2, racketLen: 0.138 },
  { t: 0.1773, hipCenter: [0.5269, 0.5615], trunk: -93.4, neck: -108.2,
    uArmL: 93.3, fArmL: 75.8, uArmR: 74.3, fArmR: 119.6,
    thighL: 94.4, shinL: 69.5, thighR: 89.2, shinR: 82.8,
    racket: -137.8, racketLen: 0.147 },
  { t: 0.197, hipCenter: [0.5241, 0.5578], trunk: -92.7, neck: -107.9,
    uArmL: 92.8, fArmL: 37.8, uArmR: 72.8, fArmR: 119.3,
    thighL: 92.2, shinL: 69.7, thighR: 88.6, shinR: 84.7,
    racket: -146.1, racketLen: 0.112 },
  { t: 0.2167, hipCenter: [0.5213, 0.5541], trunk: -92.2, neck: -107.7,
    uArmL: 91.0, fArmL: -0.2, uArmR: 70.7, fArmR: 118.7,
    thighL: 90.6, shinL: 69.8, thighR: 88.6, shinR: 86.3,
    racket: -166.3, racketLen: 0.084 },
  { t: 0.2364, hipCenter: [0.5186, 0.5511], trunk: -91.8, neck: -107.7,
    uArmL: 88.4, fArmL: -23.2, uArmR: 68.2, fArmR: 117.1,
    thighL: 89.7, shinL: 69.9, thighR: 89.1, shinR: 87.4,
    racket: 175.7, racketLen: 0.08 },
  { t: 0.2561, hipCenter: [0.516, 0.5489], trunk: -91.3, neck: -106.4,
    uArmL: 84.8, fArmL: -31.9, uArmR: 64.9, fArmR: 120.3,
    thighL: 89.4, shinL: 69.7, thighR: 89.9, shinR: 88.1,
    racket: 160.1, racketLen: 0.08 },
  { t: 0.2758, hipCenter: [0.5134, 0.5473], trunk: -90.8, neck: -103.2,
    uArmL: 80.6, fArmL: -38.2, uArmR: 61.2, fArmR: 146.9,
    thighL: 89.7, shinL: 69.7, thighR: 90.7, shinR: 88.5,
    racket: 172.5, racketLen: 0.08 },
  { t: 0.2955, hipCenter: [0.5107, 0.5484], trunk: -90.2, neck: -99.8,
    uArmL: 75.9, fArmL: -41.9, uArmR: 56.1, fArmR: -170.5,
    thighL: 90.4, shinL: 69.9, thighR: 91.5, shinR: 88.6,
    racket: -163.0, racketLen: 0.08 },
  { t: 0.3152, hipCenter: [0.5081, 0.5514], trunk: -89.8, neck: -98.0,
    uArmL: 70.5, fArmL: -43.5, uArmR: 50.4, fArmR: -123.7,
    thighL: 91.5, shinL: 70.3, thighR: 92.0, shinR: 88.2,
    racket: -130.3, racketLen: 0.08 },
  { t: 0.3348, hipCenter: [0.5055, 0.555], trunk: -89.6, neck: -98.2,
    uArmL: 63.9, fArmL: -42.8, uArmR: 44.8, fArmR: -95.3,
    thighL: 92.9, shinL: 71.9, thighR: 92.5, shinR: 87.5,
    racket: -115.4, racketLen: 0.117 },
  { t: 0.3545, hipCenter: [0.5028, 0.5584], trunk: -89.5, neck: -99.6,
    uArmL: 56.6, fArmL: -39.8, uArmR: 39.8, fArmR: -72.4,
    thighL: 94.5, shinL: 75.3, thighR: 92.6, shinR: 86.5,
    racket: -107.4, racketLen: 0.121 },
  { t: 0.3742, hipCenter: [0.5001, 0.5608], trunk: -89.6, neck: -102.6,
    uArmL: 49.9, fArmL: -33.9, uArmR: 35.7, fArmR: -49.5,
    thighL: 96.1, shinL: 79.9, thighR: 92.5, shinR: 85.1,
    racket: -95.9, racketLen: 0.092 },
  { t: 0.3939, hipCenter: [0.4971, 0.5604], trunk: -89.6, neck: -105.4,
    uArmL: 46.2, fArmL: -25.8, uArmR: 33.7, fArmR: -25.5,
    thighL: 97.8, shinL: 83.9, thighR: 92.0, shinR: 83.6,
    racket: -69.0, racketLen: 0.08 },
  { t: 0.4136, hipCenter: [0.4939, 0.5587], trunk: -89.5, neck: -106.3,
    uArmL: 46.6, fArmL: -17.4, uArmR: 34.8, fArmR: -6.5,
    thighL: 99.2, shinL: 86.1, thighR: 91.2, shinR: 82.3,
    racket: -35.3, racketLen: 0.08 },
  { t: 0.4333, hipCenter: [0.4904, 0.5562], trunk: -89.2, neck: -104.9,
    uArmL: 51.8, fArmL: -9.9, uArmR: 38.0, fArmR: 8.1,
    thighL: 100.1, shinL: 86.5, thighR: 90.2, shinR: 81.2,
    racket: -3.3, racketLen: 0.085 },
  { t: 0.453, hipCenter: [0.4867, 0.5539], trunk: -88.7, neck: -104.0,
    uArmL: 60.6, fArmL: -4.6, uArmR: 41.6, fArmR: 19.7,
    thighL: 100.6, shinL: 85.9, thighR: 89.1, shinR: 80.3,
    racket: 12.8, racketLen: 0.125 },
  { t: 0.4727, hipCenter: [0.483, 0.5523], trunk: -88.2, neck: -103.4,
    uArmL: 72.1, fArmL: -3.4, uArmR: 45.0, fArmR: 28.9,
    thighL: 100.5, shinL: 84.7, thighR: 88.1, shinR: 79.2,
    racket: 16.9, racketLen: 0.107 },
  { t: 0.4924, hipCenter: [0.4793, 0.5517], trunk: -87.6, neck: -102.3,
    uArmL: 84.6, fArmL: -5.2, uArmR: 48.5, fArmR: 35.9,
    thighL: 100.0, shinL: 83.6, thighR: 87.5, shinR: 78.2,
    racket: 15.2, racketLen: 0.095 },
  { t: 0.5121, hipCenter: [0.4761, 0.551], trunk: -87.3, neck: -99.4,
    uArmL: 97.4, fArmL: -11.5, uArmR: 51.6, fArmR: 41.7,
    thighL: 99.0, shinL: 82.9, thighR: 87.2, shinR: 77.0,
    racket: 15.2, racketLen: 0.09 },
  { t: 0.5318, hipCenter: [0.4734, 0.5494], trunk: -87.2, neck: -95.8,
    uArmL: 108.1, fArmL: -29.1, uArmR: 55.2, fArmR: 46.9,
    thighL: 97.6, shinL: 82.8, thighR: 87.2, shinR: 75.7,
    racket: 16.9, racketLen: 0.089 },
  { t: 0.5515, hipCenter: [0.4715, 0.5459], trunk: -87.4, neck: -91.5,
    uArmL: 116.1, fArmL: -62.9, uArmR: 59.7, fArmR: 52.2,
    thighL: 96.2, shinL: 83.4, thighR: 87.2, shinR: 74.5,
    racket: 21.3, racketLen: 0.09 },
  { t: 0.5712, hipCenter: [0.4702, 0.5404], trunk: -87.9, neck: -88.1,
    uArmL: 121.6, fArmL: -98.8, uArmR: 66.4, fArmR: 58.7,
    thighL: 95.1, shinL: 84.4, thighR: 87.2, shinR: 75.9,
    racket: 30.6, racketLen: 0.104 },
  { t: 0.5909, hipCenter: [0.4695, 0.5337], trunk: -88.5, neck: -86.3,
    uArmL: 126.1, fArmL: -120.4, uArmR: 76.3, fArmR: 63.9,
    thighL: 94.6, shinL: 85.8, thighR: 87.0, shinR: 77.4,
    racket: 37.3, racketLen: 0.107 },
  { t: 0.6106, hipCenter: [0.4698, 0.5272], trunk: -89.2, neck: -86.7,
    uArmL: 130.1, fArmL: -127.3, uArmR: 89.1, fArmR: 71.3,
    thighL: 94.9, shinL: 87.1, thighR: 86.8, shinR: 78.9,
    racket: 49.4, racketLen: 0.08 },
  { t: 0.6303, hipCenter: [0.4703, 0.5222], trunk: -89.8, neck: -88.9,
    uArmL: 135.7, fArmL: -129.3, uArmR: 105.3, fArmR: 106.9,
    thighL: 95.7, shinL: 88.1, thighR: 86.6, shinR: 77.4,
    racket: 88.2, racketLen: 0.08 },
  { t: 0.65, hipCenter: [0.4707, 0.519], trunk: -90.2, neck: -92.2,
    uArmL: 143.7, fArmL: -132.4, uArmR: 124.7, fArmR: 158.6,
    thighL: 96.6, shinL: 88.6, thighR: 86.4, shinR: 75.5,
    racket: 141.9, racketLen: 0.08 },
  { t: 0.6833, hipCenter: [0.4708, 0.5179], trunk: -90.4, neck: -95.5,
    uArmL: 151.4, fArmL: -132.5, uArmR: 146.9, fArmR: -148.6,
    thighL: 97.3, shinL: 88.7, thighR: 86.2, shinR: 70.2,
    racket: -165.5, racketLen: 0.08 },
  { t: 0.7167, hipCenter: [0.4707, 0.5191], trunk: -90.5, neck: -98.0,
    uArmL: 157.4, fArmL: -132.0, uArmR: 169.9, fArmR: -128.7,
    thighL: 97.5, shinL: 88.2, thighR: 85.9, shinR: 64.1,
    racket: -146.0, racketLen: 0.138 },
  { t: 0.75, hipCenter: [0.4695, 0.5214], trunk: -90.4, neck: -100.9,
    uArmL: 161.8, fArmL: -129.4, uArmR: -171.1, fArmR: -124.5,
    thighL: 97.3, shinL: 87.3, thighR: 85.5, shinR: 57.5,
    racket: -137.8, racketLen: 0.16 },
  { t: 0.7833, hipCenter: [0.4682, 0.5259], trunk: -90.2, neck: -103.4,
    uArmL: 165.2, fArmL: -126.4, uArmR: -157.8, fArmR: -124.2,
    thighL: 96.9, shinL: 86.3, thighR: 85.1, shinR: 54.2,
    racket: -136.1, racketLen: 0.16 },
  { t: 0.8167, hipCenter: [0.4674, 0.5282], trunk: -89.9, neck: -105.7,
    uArmL: 165.9, fArmL: -122.1, uArmR: -150.2, fArmR: -120.7,
    thighL: 96.5, shinL: 85.4, thighR: 84.6, shinR: 51.2,
    racket: -133.5, racketLen: 0.16 },
  { t: 0.85, hipCenter: [0.4665, 0.5313], trunk: -89.8, neck: -106.2,
    uArmL: 165.2, fArmL: -120.2, uArmR: -147.1, fArmR: -118.6,
    thighL: 96.3, shinL: 85.0, thighR: 84.5, shinR: 50.1,
    racket: -133.0, racketLen: 0.16 },
]
...
// at t=0.65 — emitted by railway-service/convert_pose_to_keyframes.py
// when the keyframes are regenerated. If they drift, the figure
// fires its swing too early/late and the ball flies past.
const RACKET_CONTACT_NORM_X = 0.35
const RACKET_CONTACT_NORM_Y = 0.315
